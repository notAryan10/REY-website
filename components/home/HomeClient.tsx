...
const FallingText = dynamic(() => import("@/components/ui/FallingText"), {
  ssr: false,
  loading: () => <div className="h-40 animate-pulse bg-stone/10 border-border/50" />
});

interface HomeClientProps {
  latestEvent: IEvent | null;
  latestProject: IProject | null;
  latestResource: IResource | null;
}

export function HomeClient({ latestEvent, latestProject, latestResource }: HomeClientProps) {
